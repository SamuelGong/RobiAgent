...
import os
import platform
from robiagent.backend.ipc.redis import RedisIPC
from robiagent.environments.base import BaseEnv
...
class BasicEnv(BaseEnv, RedisIPC):
    def __init__(self):
        RedisIPC.__init__(self, root="robiagent")
...
class AgentEnv(BasicEnv):
    ...
    def get_task_states(self, task_names):
        task_states = []
